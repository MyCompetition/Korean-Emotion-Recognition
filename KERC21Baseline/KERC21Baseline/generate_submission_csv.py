...
def eval(train_config, trained_model_path, test_set, device):
    ...
    submission_df.to_csv(f'logs/saved_model/submission_{test_set}.csv', index=False)
...
if __name__ == '__main__':
    ...
    val_test = 'test' # change accordingly
    
    eval(train_configs, 'logs/saved_model/saved_model.pt', val_test, device)  #val or test